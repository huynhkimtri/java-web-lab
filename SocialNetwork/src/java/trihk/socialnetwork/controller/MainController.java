...
public class MainController extends HttpServlet {
    ...
    private final String ACTION_WRITE = "write-article";
    ...
    private final String writeArticleServlet = "WriteArticleServlet";
    private final String detailArticleServlet = "Detail";
